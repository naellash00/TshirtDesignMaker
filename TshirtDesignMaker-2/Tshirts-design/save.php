...
$stmt = $conn->prepare("INSERT INTO prevdesigns (logo_url, logo_size, tscolor_url, words, words_color, design_id, priproduct, quantity) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
$stmt->bind_param("ssssssss", $logoURL, $logoSize, $tscolorURL, $words, $wordsColor, $designID, $priProduct, $quantity);
